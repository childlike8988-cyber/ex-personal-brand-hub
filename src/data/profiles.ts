...
export const profiles: Record<Profile["type"], Profile> = {
  realty: {
    ...
    person: { name: "Ernest 周先生", role: "房地產顧問 / 不動產服務", area: "台北市・新北市・桃園市", line: "@ex.realtor", phone: "0912-345-678", email: "ernest@exrealtor.com", note: "值得信賴・用心服務" },
    showcase: {
    ...
    modules: ["實價登錄", "社區地圖", "預約看屋", "生活機能", "影音", "更多功能"],
  },
  generic: {
    ...
    person: { name: "Ernest 周先生", role: "品牌顧問 / 行銷服務", area: "高雄市・新北市・台中市", line: "@ex.marketing", phone: "0912-345-678", email: "ernest@exmarketing.com", note: "品牌策略・用心服務" },
    showcase: {
